...
func (api *EncodingManifestsDashApi) Start(manifestId string) (*model.BitmovinResponse, error) {
    ...
    var responseModel *model.BitmovinResponse
    err := api.apiClient.Post("/encoding/manifests/dash/{manifest_id}/start", struct{}{}, &responseModel, reqParams)
    return responseModel, err
}
...
func (api *EncodingManifestsDashApi) Stop(manifestId string) (*model.BitmovinResponse, error) {
    ...
    var responseModel *model.BitmovinResponse
    err := api.apiClient.Post("/encoding/manifests/dash/{manifest_id}/stop", struct{}{}, &responseModel, reqParams)
    return responseModel, err
}
