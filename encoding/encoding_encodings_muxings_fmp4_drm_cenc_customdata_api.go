...
func NewEncodingEncodingsMuxingsFmp4DrmCencCustomdataApi(configs ...func(*common.ApiClient)) (*EncodingEncodingsMuxingsFmp4DrmCencCustomdataApi, error) {
    ...
    api := &EncodingEncodingsMuxingsFmp4DrmCencCustomdataApi{apiClient: apiClient}
...
func (api *EncodingEncodingsMuxingsFmp4DrmCencCustomdataApi) Get(encodingId string, muxingId string, drmId string) (*model.CustomData, error) {
    ...
    err := api.apiClient.Get("/encoding/encodings/{encoding_id}/muxings/fmp4/{muxing_id}/drm/cenc/{drm_id}/customData", &responseModel, reqParams)
