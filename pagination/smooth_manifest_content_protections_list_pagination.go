...
type SmoothManifestContentProtectionsListPagination struct {
  ...
  func (o *SmoothManifestContentProtectionsListPagination) UnmarshalJSON(b []byte) error {
    var items []model.SmoothManifestContentProtection
    ...
    for _, i := range pageResp.Items {
      var v model.SmoothManifestContentProtection
