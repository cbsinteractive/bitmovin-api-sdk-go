...
type EncodingStatisticsVodsListByDateRangePagination struct {
  ...
  func (o *EncodingStatisticsVodsListByDateRangePagination) UnmarshalJSON(b []byte) error {
    var items []model.EncodingStatisticsVod
    ...
    for _, i := range pageResp.Items {
      var v model.EncodingStatisticsVod
