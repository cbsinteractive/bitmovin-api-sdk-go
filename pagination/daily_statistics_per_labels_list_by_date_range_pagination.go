...
type DailyStatisticsPerLabelsListByDateRangePagination struct {
  ...
  func (o *DailyStatisticsPerLabelsListByDateRangePagination) UnmarshalJSON(b []byte) error {
    var items []model.DailyStatisticsPerLabel
    ...
    for _, i := range pageResp.Items {
      var v model.DailyStatisticsPerLabel
