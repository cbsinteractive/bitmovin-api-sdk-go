...
type EncodingErrorEmailNotificationsCreatePagination struct {
  ...
  func (o *EncodingErrorEmailNotificationsCreatePagination) UnmarshalJSON(b []byte) error {
    var items []model.EncodingErrorEmailNotification
    ...
    for _, i := range pageResp.Items {
      var v model.EncodingErrorEmailNotification
