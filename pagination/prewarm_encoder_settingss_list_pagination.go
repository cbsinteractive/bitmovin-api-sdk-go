...
type PrewarmEncoderSettingssListPagination struct {
	TotalCount *int64           `json:"totalCount,omitempty"`
	Offset     *int32           `json:"offset,omitempty"`
	Limit      *int32           `json:"limit,omitempty"`
	Previous   string           `json:"previous,omitempty"`
	Next       string           `json:"next,omitempty"`
	Items      []model.PrewarmEncoderSettings `json:"items,omitempty"`
}


  func (o *PrewarmEncoderSettingssListPagination) UnmarshalJSON(b []byte) error {
    var items []model.PrewarmEncoderSettings
    ...
    for _, i := range pageResp.Items {
      var v model.PrewarmEncoderSettings
