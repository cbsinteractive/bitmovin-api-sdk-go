...
type NotificationStateEntrysListByNotificationIdPagination struct {
  ...
  func (o *NotificationStateEntrysListByNotificationIdPagination) UnmarshalJSON(b []byte) error {
    var items []model.NotificationStateEntry
    ...
    for _, i := range pageResp.Items {
      var v model.NotificationStateEntry
