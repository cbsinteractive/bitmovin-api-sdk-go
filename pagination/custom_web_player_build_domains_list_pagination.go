...
type CustomWebPlayerBuildDomainsListPagination struct {
  ...
  func (o *CustomWebPlayerBuildDomainsListPagination) UnmarshalJSON(b []byte) error {
    var items []model.CustomWebPlayerBuildDomain
    ...
    for _, i := range pageResp.Items {
      var v model.CustomWebPlayerBuildDomain
