...
type SmoothStreamingRepresentationsListPagination struct {
  ...
  func (o *SmoothStreamingRepresentationsListPagination) UnmarshalJSON(b []byte) error {
    var items []model.SmoothStreamingRepresentation
    ...
    for _, i := range pageResp.Items {
      var v model.SmoothStreamingRepresentation
