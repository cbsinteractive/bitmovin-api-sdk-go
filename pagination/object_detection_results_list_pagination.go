...
type ObjectDetectionResultsListPagination struct {
	TotalCount *int64           `json:"totalCount,omitempty"`
	Offset     *int32           `json:"offset,omitempty"`
	Limit      *int32           `json:"limit,omitempty"`
	Previous   string           `json:"previous,omitempty"`
	Next       string           `json:"next,omitempty"`
	Items      []model.ObjectDetectionResult `json:"items,omitempty"`
}


  func (o *ObjectDetectionResultsListPagination) UnmarshalJSON(b []byte) error {
    var items []model.ObjectDetectionResult
    ...
    for _, i := range pageResp.Items {
      var v model.ObjectDetectionResult
