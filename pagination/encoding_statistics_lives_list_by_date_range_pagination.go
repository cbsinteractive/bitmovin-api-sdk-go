...
type EncodingStatisticsLivesListByDateRangePagination struct {
  ...
  func (o *EncodingStatisticsLivesListByDateRangePagination) UnmarshalJSON(b []byte) error {
    var items []model.EncodingStatisticsLive
    ...
    for _, i := range pageResp.Items {
      var v model.EncodingStatisticsLive
