...
type EmailNotificationWithStreamConditionssListPagination struct {
  ...
  func (o *EmailNotificationWithStreamConditionssListPagination) UnmarshalJSON(b []byte) error {
    var items []model.EmailNotificationWithStreamConditions
    ...
    for _, i := range pageResp.Items {
      var v model.EmailNotificationWithStreamConditions
